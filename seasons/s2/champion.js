const MB_KEYS = {
  profile: "mb_profile",
  // Season 2 keys (must match seasons/s2/app.js and quizzes)
  ...
  champPngUpload: "mb_s2_champ_png_upload",
...
function saveChampionPreview() {
  ...
  try {
    ...
    if (preview && preview.startsWith("data:image/")) {
      setItemWithRetryS2(MB_KEYS.champPng, preview);
      if (uploadPng && uploadPng.startsWith("data:image/png")) {
        setItemWithRetryS2(MB_KEYS.champPngUpload, uploadPng);
      }
      setItemWithRetryS2(MB_KEYS.champReady, "1");
    }
  } catch (e) {
