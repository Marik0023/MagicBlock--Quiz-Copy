const MB_KEYS = {
  profile: "mb_profile",
  doneMovie: "mb2_done_silhouette",
  resMovie: "mb2_result_silhouette",
  prevMovie: "mb2_prev_silhouette",

  progMovie: "mb2_prog_silhouette",            // number (1..10)
  progMovieState: "mb2_prog_silhouette_state", // JSON { idx, correct, answers }
...
function saveProgressMovie(idx0, correct, answers) {
  ...
  // Store NEXT question number so Season home can show "Continue" + % progress.
