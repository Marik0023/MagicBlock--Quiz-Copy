const MB_KEYS = {
  ...
  doneMagic: "mb2_done_movieemoji",
  resMagic: "mb2_result_movieemoji",
  prevMagic: "mb2_prev_movieemoji",

  progMagic: "mb2_prog_movieemoji",
  progMagicState: "mb2_prog_movieemoji_state",

  reviewHiddenMagic: "mb_review_hidden_magicblock",
};

const QUIZ_CARD = {
  // Used on result card (canvas export)
...
function saveProgressMagic(idx0, correct, answers) {
  ...
  const qNum = Math.max(1, Math.min(total, idx + 2));
