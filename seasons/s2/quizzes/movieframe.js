localStorage.setItem("mb_last_s2", "Movie Frame");
...
const MB_KEYS = {
  ...
  doneMovie: "mb_s2_done_movieframe",
  resMovie: "mb_s2_result_movieframe",
  prevMovie: "mb_s2_prev_movieframe",

  progMovie: "mb_s2_prog_movieframe",            // number (1..10)
  progMovieState: "mb_s2_prog_movieframe_state", // JSON { idx, correct, answers }

  // ✅ Answer Review: hide forever after Generate
  reviewHiddenMovie: "mb_s2_review_hidden_movieframe",
};

const PNG_KEY = "mb_s2_png_movieframe";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const QUESTIONS = [
    ...
    { frame: "../../../assets/movies/12.mp4", options: ["Thor", "Captain America", "Spider-Man", "Iron Man"], correctIndex: 3 },
    ...
    { frame: "../../../assets/movies/18.mp4", options: ["21 Jump Street", "The Hangover", "Ted", "Bad Neighbors"], correctIndex: 2 },
...
function injectBreadcrumb(){
  ...
  crumbs.innerHTML = `<a href="../../../index.html">All Seasons</a> / <a href="../index.html">Season 2</a> / <span>Movie Frame</span>`;
