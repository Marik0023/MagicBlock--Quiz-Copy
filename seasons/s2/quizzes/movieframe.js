const MB_KEYS = {
  profile: "mb_profile",
  doneMovie: "mb2_done_movieframe",
  resMovie: "mb2_result_movieframe",
  prevMovie: "mb2_prev_movieframe",

  progMovie: "mb2_prog_movieframe",            // number (1..10)
  progMovieState: "mb2_prog_movieframe_state", // JSON { idx, correct, answers }
...
function saveProgressMovie(idx0, correct, answers) {
  ...
  // Store NEXT question number (1..10).
  // Home page shows progress only when prog >= 2 (meaning user answered at least 1 question).
  const qNum = Math.max(1, Math.min(10, idx + 2));
