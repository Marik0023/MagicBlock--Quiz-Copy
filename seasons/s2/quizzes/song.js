...
const MB_KEYS = {
  ...
  prevSong: "mb2_prev_song",

  // HOME progress
  progSong: "mb2_prog_song",
  progSongState: "mb2_prog_song_state", // JSON { idx, correct, answers }
...
function saveProgressSong(idx, correct, answers) {
  ...
  // Store NEXT question number (1..10) so Season home can show "Continue" + % progress.
  const qNum = Math.min(10, clampedIdx + 2);
