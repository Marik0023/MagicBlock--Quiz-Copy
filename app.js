...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Achievements live in Season 1 for now (open modal via hash)
  const ach = document.getElementById("achievementsBtn");
  if (ach) ach.addEventListener("click", () => (location.href = "seasons/s1/index.html#achievements"));
